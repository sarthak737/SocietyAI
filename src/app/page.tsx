    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] p-6 animate-fade-in">
      ...
      <div className="grid md:grid-cols-2 gap-8 w-full max-w-4xl">
        ...
        <div className="glass-panel p-10 rounded-3xl hover:shadow-soft transition-all duration-300 group relative overflow-hidden">
          ...
          <div className="bg-teal-100 text-teal-600 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 shadow-sm">
            <HomeIcon size={32} />
          </div>
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Resident Portal</h2>
          ...
          <Link href="/login?role=resident" className="inline-block w-full text-center bg-gray-900 text-white font-semibold py-4 px-6 rounded-xl hover:bg-gray-800 transition-colors shadow-md">
            Login as Resident
          </Link>
        </div>
